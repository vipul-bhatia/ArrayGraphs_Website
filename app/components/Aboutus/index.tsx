...
const Aboutdata: datatype[] = [
  {
    heading: "Online Advertising Services",
  ...
  {
    heading: "Campaign Design & Management",
    imgSrc: "/images/aboutus/imgOne.svg",
...
const Aboutus = () => {
  return (
    <div id="aboutus-section">
      <div className="mx-auto max-w-7xl px-4 py-12 my-8 lg:px-10 bg-lightgrey  relative">
        <Image
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 my-10 gap-x-10 lg:gap-x-30">
  {Aboutdata.map((item, i) => (
    <div
      key={i}
      className="hover:bg-navyblue bg-white rounded-3xl pt-10 pl-8 pb-10 pr-6 shadow-xl group transform transition-transform hover:scale-105 mt-8"
    >
